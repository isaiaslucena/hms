<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'manage_exam_type') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/exam_type">
                <i class="fa fa-file-text-o"></i>
                <!--<i class="fa fa-folder-o"></i>-->
                <span><?php echo get_phrase('exam_type'); ?></span>
            </a>
        </li>
            ...
            echo 'opened active';?> ">
                ...
                <ul>
                    ...
                    <li class="<?php if ($page_name == 'manage_requested_appointment') echo 'active'; ?> ">
                        <a href="<?php echo base_url(); ?>index.php?admin/appointment_requested">
                            <i class="entypo-dot"></i>
