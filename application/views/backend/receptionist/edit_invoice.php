        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open('index.php?receptionist/invoice_manage/update/' . $param2, array('class' => 'form-horizontal form-groups validate invoice-edit', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <select name="patient_id" class="select2">
                                ...
                                foreach ($patients as $row2):
                                    ...
                                    <option value="<?php echo $row2['patient_id']; ?>"	
                                        <?php if ($row['client_id'] == $row2['patient_id']) echo 'selected'; ?>>
                                            <?php echo $row2['name']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
