            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal form-groups-bordered" role="form" method="post"
                        action="<?php echo base_url(); ?>index.php?receptionist/notice/update/<?php echo $row['notice_id']; ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="date-and-time">
                                    ...
                                    data-format="dd/mm/yyyy" value="<?php echo date("d/m/Y", $row['start_timestamp']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="date-and-time">
                                    ...
                                    data-format="dd/mm/yyyy" value="<?php echo date("d/m/Y", $row['end_timestamp']); ?>">
                                </div>
                            </div>
                        </div>
