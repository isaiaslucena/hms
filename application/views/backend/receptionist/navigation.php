<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'show_receipt_patient' || $page_name == 'show_receipt_doctor') echo 'opened active has-sub'; ?> ">
            <a href="#">
                <i class="fa fa-list-alt"></i>
                <span><?php echo get_phrase('receipt'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'show_receipt_patient') echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?receptionist/receipt_patient_manage">
                        <i class="fa fa-user"></i>
                        <span><?php echo get_phrase('patient'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'show_receipt_doctor') echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?receptionist/receipt_doctor_manage">
                        <i class="fa fa-plus"></i>
        ...
        <li class="<?php if ($page_name == 'manage_notice') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?receptionist/notice">
